...
static const cmd_type_t BG96_COMMAND_INIT[] = {
		{ AT_IFC_A, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_CMD, 					AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ ATE1_A, 					AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_CMEE_A, 				AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ ATV1_A, 					AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_AND_D0_A, 				AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_CGMR_CMD, 				AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_CFUN_0_A, 				AT_OK_STRING, CMD_TIMEOUT_15000, FSM_TIMEOUT_100 },
		{ AT_QCFG_BAND_A, 			AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_QCFG_IOT_A, 			AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_QCFG_NWSCANSEQ_A, 		AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },
		{ AT_QCFG_NWSCANMODE_A, 	AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 },

		{ END_OF_ARRAY, AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 }, };

static const cmd_type_t BG96_COMMAND_1[] = {
		{ AT_QICSGP1_A, 			AT_OK_STRING,CMD_TIMEOUT_5000, FSM_TIMEOUT_20000 },
		{ AT_QICSGP2_A, 			AT_OK_STRING,CMD_TIMEOUT_5000, FSM_TIMEOUT_20000 },
		{ AT_CFUN_1_A, 				AT_OK_STRING,CMD_TIMEOUT_15000, FSM_TIMEOUT_20000 },
		{ AT_QCCID_CMD, 			AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_20000 },

		{ END_OF_ARRAY, 			AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_100 }, };

static const cmd_type_t BG96_COMMAND_2[] = {

		{ AT_QINITSTAT_CMD, 		AT_ERROR_STRING, CMD_TIMEOUT_300,FSM_TIMEOUT_20000 },
		{ AT_QINITSTAT_CMD,			AT_ERROR_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_20000 },
		{ AT_QINITSTAT_CMD, 		AT_ERROR_STRING, CMD_TIMEOUT_300,FSM_TIMEOUT_20000 },
...
static const cmd_type_t BG96_COMMAND_3[] = {
		{ AT_CPIN_Q, 				AT_OK_STRING,CMD_TIMEOUT_5000, FSM_TIMEOUT_20000 },
		{ AT_QGMR_CMD, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_CPIN_Q, 				AT_OK_STRING,CMD_TIMEOUT_5000, FSM_TIMEOUT_20000 },
		{ AT_CGDCONT_Q, 			AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_20000 },
		{ AT_CREG_A, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_90000 },
		{ AT_CGREG_A, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_CEREG_A, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_GSN_CMD, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_CGMI_CMD, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_CGMM_CMD, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_QGMR_CMD, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_CGSN_CMD, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_QCCID_CMD, 			AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_20000 },
		{ AT_CIMI_CMD, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_20000 },
		{ AT_COPS_Q, 				AT_OK_STRING,CMD_TIMEOUT_180000, FSM_TIMEOUT_20000 },
		{ AT_COPS_A, 				AT_OK_STRING,CMD_TIMEOUT_180000, FSM_TIMEOUT_20000 },
		{ AT_CEREG_Q, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_CREG_Q, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_90000 },
		{ AT_CGREG_Q, 				AT_OK_STRING,CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_CGATT_A, 				AT_OK_STRING,CMD_TIMEOUT_140000, FSM_TIMEOUT_60000 },
/*{AT_CSQ_CMD, 				CMD_TIMEOUT_300,		FSM_TIMEOUT_60000},
 ...
 {AT_CGATT_Q, 				CMD_TIMEOUT_140000,		FSM_TIMEOUT_60000},*/
		{ AT_CGEREP_A, 				AT_OK_STRING, CMD_TIMEOUT_300, FSM_TIMEOUT_60000 },
		{ AT_QICSGP_A,				AT_OK_STRING, CMD_TIMEOUT_150000, FSM_TIMEOUT_150000 },
		{ AT_QIACT_Q,				AT_OK_STRING, CMD_TIMEOUT_150000, FSM_TIMEOUT_150000 },
		{ AT_QIACT_A,				AT_OK_STRING, CMD_TIMEOUT_150000, FSM_TIMEOUT_150000 },
		{ AT_QIACT_Q,				AT_OK_STRING, CMD_TIMEOUT_150000, FSM_TIMEOUT_150000 },
...
static uint8_t pub_topic[32] = "ME/ID0999RX/PC";//
static uint8_t sub_topic[32] = "ME/ID0999TX/PC";//
